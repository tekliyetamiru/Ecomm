...
urlpatterns = [
    ...
    path('registration/',views.CustomerRegisterionView.as_view(),name="customerregistration"),
    ...
    path('login/',auth_view.LogoutView.as_view(template_name='login'),name='logout'),
